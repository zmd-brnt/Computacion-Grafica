// Previo 8                     Pérez Paitán Brent Armando
// 24/03/2026                                    320099649
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "P8 Perez Paitan Brent Armando", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		glUniform1d(glGetUniformLocation(lightingShader.Program, "material.shininess"), 0.8f);
       ...
       /* glDrawArrays(GL_TRIANGLES, 0, 36);*/
        ...
        glm::vec3 secondLightPos = glm::vec3(-2.5f, 1.0f, 1.5f);
        model = glm::mat4(1.0f);
        model = glm::translate(model, secondLightPos);
        model = glm::scale(model, glm::vec3(0.3f));
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        glDrawArrays(GL_TRIANGLES, 0, 36);
