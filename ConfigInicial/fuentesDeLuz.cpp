// Previo 9							Pérez Paitán Brent Armando
// 07/03/2026										 320099649
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "P9 Perez Paitan Brent Armando", nullptr, nullptr);
	...
	Model Dog((char*)"Models/Window.obj");
